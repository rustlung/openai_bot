...
async def cmd_help(message: Message) -> None:
    ...
    text = (
        ...
        "<b>Генерация:</b>\n"
        "/image &lt;описание&gt; — сгенерировать картинку\n"
        "<s>/video</s> — <i>ожидает верификации</i>\n\n"
        "<b>Статистика:</b>\n"
...
# Sora 2 требует верификации организации в OpenAI
# После прохождения верификации установите VIDEO_ENABLED = True
VIDEO_ENABLED = False
...
async def cmd_video(message: Message, command: CommandObject) -> None:
    ...
    if not VIDEO_ENABLED:
        await message.answer(
            ...
            "Для использования Sora 2 требуется верификация организации в OpenAI.\n"
            "Верификация находится на рассмотрении.\n\n"
            "Функция будет включена после прохождения верификации.\n\n"
